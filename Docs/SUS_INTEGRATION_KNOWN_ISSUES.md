...
Revealed during creation `sus-demo` (a separate Unity project using sus-core + downstream library + sus-router as local packages).
...
9. Warnings from `downstream library/Generated/` - expected, not design errors
