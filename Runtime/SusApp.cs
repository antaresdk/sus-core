...
namespace Sharq.Core
{
    ...
    ///   A. Kit showcase — <c>ApplyDefaultTSS</c> + <c>Mount&lt;T&gt;</c>;
    ...
    /// Usage:
    /// <code>
    /// // Single component (kit showcase)
    /// SusApp.Create(uiDocument).Mount&lt;KitShowcaseScreen&gt;();
    ///
    /// // Manual UI
    ...
    public sealed class SusApp
    {
        ...
        /// kit L4/L5), so they form the TOP override layer and can redefine
        ...
        /// <c>--sk-font-body</c> without touching kit spacing/shape). Applied to the root AND
