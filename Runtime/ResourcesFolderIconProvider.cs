...
namespace Sharq.Core
{
    ...
    public class ResourcesFolderIconProvider : ISusIconProvider
    {
        ...
        private VectorImage LoadInEditorWithRepair(string path)
        {
            ...
            // (BasicKit black screen: SusToggle → missing core icon → Refresh → empty panel).
    ...
    /// the ~system icons kit/core components use by default (carets, check, x, magnifying-glass…).
    /// Guarantees SUS works without the optional Phosphor package. Registered as the default
