...
namespace Sharq.Core
{
    ...
    public static class SusBootstrap
    {
        ...
        /// Names are relative to <see cref="ResourcePath"/> (e.g. "downstream-tokens").
        /// </summary>
        ...
        /// <see cref="ResourcePath"/>, e.g. "downstream-tokens"). Appended after core tokens
        ...
        private static void LoadDesignTokenCascade(VisualElement container)
        {
            ...
            // Resolution axis: root .breakpoint-* + suskit-breakpoints.uss (not density/scale).
        ...
        /// without mounting a component. Use when you build UI manually (e.g. Kit Demo)
        ...
        /// <summary>
        /// Runtime PanelSettings for the world UIDocument. Sets
        /// <c>renderMode = WorldSpace</c> when the Unity version exposes that API (6.2+).
        /// </summary>
        ...
        /// compiles against Unity 6000.0 (API shipped in 6.2+). No-op if unavailable.
        /// </summary>
        static void TrySetWorldSpaceRenderMode(PanelSettings ps)
        {
            if (ps == null) return;
